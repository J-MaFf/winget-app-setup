...
diagnosed and (for #279) worked around by staying off the affected pass where possible.
...
| `.github/workflows/e2e-install.yml` | E2E tier 1: weekly real install run on GitHub-hosted `windows-latest` (issues #279/#282; schedule + dispatch + self-validating PRs; failure auto-files an issue) |
